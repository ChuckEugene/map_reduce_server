...
def worker_message_generator(mock_socket, master_log):
    ...
    utils.wait_for_log(master_log, "end map stage")
...
def test_master_02_map(mocker, caplog):
    ...
    # Verify first 3 messages sent by the master
    #
